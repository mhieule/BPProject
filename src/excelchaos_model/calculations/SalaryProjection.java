...
public class SalaryProjection {
    ...
    public String[][] getNextPayLevelProjection(){
        ...
        for (Contract contract : contracts){
            ...
            payLevelIncreases = ProjectedSalaryModel.calculateNextPayLevelDate(contract.getStart_date(),stufe);
            ...
            payLevelIncreases = ProjectedSalaryModel.calculateNextPayLevelDate(payLevelIncreases.get(0),firstIncreaseLevel);
